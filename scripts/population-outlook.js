const POP_COLORS = ['#8faec3','#97b7ab','#c7b88f','#cfa08b','#9d90ba'];
...
function style(feature) { const value=feature.properties.values[String(state.year)][state.metric]||0; return { color:'rgba(255,255,255,.72)', weight:.45, fillColor:color(value), fillOpacity:value===0?0:.28 }; }
